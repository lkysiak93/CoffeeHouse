...
<head>
    ...
    <asset:link rel="icon" href="icon_bean_of_coffe.png" type="image/x-ico"/>
...
<nav class="navbar navbar-expand-lg navbar-dark navbar-static-top" role="navigation">
    <div class="container-fluid">
        <a class="navbar-brand" href="/#"><asset:image src="logo_coffee.png" alt="Coffe Logo"/>Coffee House</a>
